...
HELP_STRINGS = """
Hey there! My name is *XFlickzRobot*.
...
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://t.me/XFlickz)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/a30bd9836f7d9a0ed0651.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="[► Help ◄]",callback_data="help_back"),InlineKeyboardButton(text="[► Developer ◄]",url="https://t.me/XFlick")]]
    keyboard += [[InlineKeyboardButton(text="[► Source ◄]",url="https://github.com/GENZxM"),InlineKeyboardButton(text="[► Add Me ◄]",url="t.me/{}?startgroup=true".format(bot.username))]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="[► Developer ◄]",url="https://t.me/XFlick")]]))
        return
